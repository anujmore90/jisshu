...
auth_channel = environ.get('AUTH_CHANNEL', '-1002471720790')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002397413548'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002493921046') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002458449312')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002397413548') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
